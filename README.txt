...
peers we don't want them all to acces these variables at the same time. My idea was that the manager will hold an array of piece indices or
...
run: java RUBTClient Phase1.torrent musicVideo.mov
